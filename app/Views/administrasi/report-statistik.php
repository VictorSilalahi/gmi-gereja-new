...
<body>
            ...
            <div class="col-10">
                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="/administrasi/report/statistik">Statistik</a>
                            </li>
                        </ul>                    
  ...
  <script src="{{ url_for('static', filename='administrasi/report-statistik.js') }}" type="module"></script>
