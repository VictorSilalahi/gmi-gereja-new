                        ...
                        <div class="container-fluid">
                          ...
                          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                              ...
                              <a class="nav-link active" aria-current="page" href="<?php echo(base_url()); ?>jabatan">Pelayanan</a>
          ...
          <div class="col-10">
            ...
            <div class="row">
              <div class="mb-3 row">
                ...
                <label class="col-form-label col-sm-1">Pengangkatan:</label>
                <div class="col-sm-2">
                  <input type="date" id="tglPengangkatan" name="tglPengangkatan" class="form-control" />
                </div>
