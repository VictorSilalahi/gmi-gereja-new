...
<body>
            ...
            <div class="col-10">
                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo(base_url()); ?>report/statuskeanggotaan">Status Keanggotaan</a>
                            </li>
                            <li class="nav-item">
  ...
  <script src="<?php echo(base_url()); ?>assets/js/administrasi/report-statuskeanggotaan.js" type="module"></script>
