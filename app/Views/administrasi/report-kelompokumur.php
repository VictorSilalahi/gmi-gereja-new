...
<head>
    ...
    <title>Report | Kelompok Umur | Administrasi</title>
</head>
...
<body>
            ...
            <div class="col-10">
                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo(base_url()); ?>report/kelompokumur">Kelompok Umur</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="row">
                      <label class="col-sm-2">Pilih Kelompok Umur</label>
                      <select class="col-form-label col-sm-4" id="slcKelompokUmur">
                        <option value="">-</option>
  ...
  <script src="<?php echo(base_url()); ?>assets/js/administrasi/report-kelompokumur.js" type="module"></script>
