...
<body>
                        ...
                        <div class="container-fluid">
                          ...
                          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                              ...
                              <a class="nav-link active" aria-current="page" href="<?php echo(base_url()); ?>sektor">Sektor</a>
  ...
  <script src="<?php echo(base_url()); ?>assets/js/administrasi/sektor.js" type="module"></script>
