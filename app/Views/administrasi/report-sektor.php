...
<body>
            ...
            <div class="col-10">
                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/administrasi/report/sektor">Sektor</a>
                            </li>
                            <li class="nav-item">
  ...
  <script src="{{ url_for('static', filename='administrasi/report-sektor.js') }}" type="module"></script>
