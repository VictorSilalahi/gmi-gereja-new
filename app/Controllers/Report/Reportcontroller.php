...
class Reportcontroller extends BaseController
{
    ...
    public function status_keanggotaan()
    {
        ...
        $sql = "select tjemaat.jemaat_id, tsektor.no_sektor, tjemaat.nik, tjemaat.alamat, tjemaat.mobile_phone from tjemaat, tsektor where tjemaat.sektor_id=tsektor.sektor_id and tjemaat.status_keanggotaan='".$status_keanggotaan."'";
        $query = $db->query($sql);
    ...
    public function get_data_statistik()
    {
        ...
        $sql = "select count(tsektor.nama_sektor) as jumlah, tsektor.nama_sektor from tanggotajemaat, tjemaat, tsektor where tanggotajemaat.jemaat_id=tjemaat.jemaat_id and tjemaat.sektor_id=tsektor.sektor_id and tanggotajemaat.anggotajemaat_id not in (select twafat.anggotajemaat_id from twafat)";
