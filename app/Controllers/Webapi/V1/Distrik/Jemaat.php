...
class Jemaat extends BaseController
{
    ...
    public function jemaat_gereja()
    {
        
        // $gereja_id = $this->request->getUri()->getSegments();
        $gereja_id = $this->request->getUri()->getSegment(6);
    ...
    public function aktifitas_user() 
    {
        ...
        $tujuan = ['jemaat', 'jabatan', 'pejabat', 'organisasi', 'anggota-organisasi', 'kegiatan'];
